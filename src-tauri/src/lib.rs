...
#[cfg(target_os = "android")]
pub use android_stubs::*;

#[cfg(target_os = "android")]
pub use commands::proxy_android_stub::{handle_android_stealth_request, handle_android_stealth_request_stream};
...
pub fn run() {
    tauri::Builder::default()
        ...
        .setup(|app| {
            #[cfg(target_os = "android")]
            {
                info!("Android Stealth Layer Active");
