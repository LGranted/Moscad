...
#[cfg(not(target_os = "android"))] use crate::proxy::ProxyConfig;
#[cfg(not(target_os = "android"))] use crate::modules::cloudflared::CloudflaredConfig;
...
pub struct AppConfig {
    ...
    #[cfg(not(target_os = "android"))] pub proxy: ProxyConfig,
...
impl AppConfig {
    pub fn new() -> Self {
        Self {
            ...
            #[cfg(not(target_os = "android"))]
            #[cfg(not(target_os = "android"))] proxy: Default::default(),
